...
function main() {
  ...
  console.log("Digite um número para a espécie de animal: [1-LEAO, 2-LEOPARDO, 3-CROCODILO, 4-MACACO, 5-GAZELA, 6-HIPOPOTAMO]");
  const especieNumero = parseInt(prompt('Número da espécie: '), 10);
  const quantidade = parseInt(prompt('Digite a quantidade de animais: '), 10);

  const resultado = recintosZoo.analisaRecintos(especieNumero, quantidade);
